...
# Apply LoRA (optional but recommended for Phi-2)
if USE_LORA:
...
### Response:
{example['response']}"""
    return {"input_ids": tokenizer(prompt, truncation=True, padding="max_length", max_length=1024, return_tensors="pt")["input_ids"].squeeze()}
